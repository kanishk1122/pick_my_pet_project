...
const Footer = () => {
  return (
    <footer className="bg-gradient-to-b from-transparent to-white/50 rounded-t-3xl mt-auto">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="col-span-1 md:col-span-2">
            <div className="flex items-center space-x-2">
              <FooterIcon.Paw />
              <h1 className="text-2xl font-bold text-gray-800">Pick My Pet</h1>
            </div>
            <p className="mt-4 text-gray-600 max-w-md">
              Connecting hearts and paws. Your trusted platform for pet adoption and rehoming, making tails wag and families complete.
            </p>
        ...
        <div className="mt-12 pt-8 border-t border-gray-200">
          <p className="text-center text-gray-400">
            © {new Date().getFullYear()} Pick My Pet. All rights reserved.
          </p>
        </div>
      </div>
    </footer>
